...
<head>
    ...
    <link rel="manifest" href="/assets/pwa/site.webmanifest?v=22">
    <link rel="shortcut icon" href="/assets/pwa/favicon.ico?v=4" type="image/x-icon">
    ...
    <link rel="prefetch" href="/assets/db/prelevements.db?v=1">
</head>
