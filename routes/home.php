...
<p>Bien que ce site soit gratuit à tous et sans publicités, sa maintenance et son développement sont entièrement à ma charge, en temps et en argent. Si vous souhaitez soutenir mon travail, votre contribution serait grandement appréciée. <a href="https://iheb.tn/donate"><b>Faire un don sur ce lien</b></a></p>
<h2>Mes Projets</h2>
...
<h3>🔬 <a hx-get="/apiprofil" hx-target="#content" hx-swap="outerHTML" hx-select="#content">APIprofil</a></h3>
<p>Un outil pour visualiser le profil biochimique typique d'un taxon donné à partir des bases de données API.</p>
<h3>🧮 <a hx-get="/countercell" hx-target="#content" hx-swap="outerHTML" hx-select="#content">CounterCell</a></h3>
<p>Un compteur de cellules pour réaliser des formules leucocytaires (frottis sanguin) ou des examens directs (LCR, etc.).</p>
